...
class AdminUserController extends Controller
{
    ...
    {
        return view('BackEnd.SuperAdmin.Admin.index');
    }
    ...
    public function LoadAll()
    {
        ...
        return Datatables::of($users)
            ...
            ->addColumn('action', function ($users) {
                ...
                $button .= '<button id="dataedit" type="button" name="delete" data-id="' . $users->id . '" class="delete btn btn-info btn-sm">Edit</button>';
                $button .= '&nbsp;&nbsp;';
                $button .= '<button id="datadelete" type="button" name="delete" data-id="' . $users->id . '" class="btn btn-danger btn-sm">Delete</button>';
                $button .= '</div>';
                return $button;
            })
            ->make(true);
    ...
    public function edit($id)
    {
        ...
        $user = Admin::find($id);
        return view('BackEnd.SuperAdmin.Admin.edit', compact('user'));
    }
