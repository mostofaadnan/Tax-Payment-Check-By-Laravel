<div class="modal fade" id="unionmodel" tabindex="-1" aria-labelledby="unionmodel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="exampleInputPassword2" class="col-form-label">Union Name</label>
            ...
            <div class="modal-footer">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" id="unioninsert" class="btn btn-primary">Save</button>
                </div>
            </div>
        </div>
    </div>
