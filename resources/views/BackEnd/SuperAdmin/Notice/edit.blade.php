    ...
    <div class="page-content">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Notice Update</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('notice.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="date" id="date" class="form-control" value="{{ $Notice->date }}"
                            placeholder="Date">
                    </div>
                    <div class="form-group">
...
?>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <option value="2" {{ $Notice->status==2?'Selected':'' }}>Draft</option>
                            </select>
                        </div>
                    </div>
                    <div class="float-end">
