    ...
    <div class="page-content">
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    <a class="btn btn-info" href="{{ route('notice.create') }}">New Notice</a>
                </div>
            </div>
            <div class="card-body">
...
$(document).on('click', '#datashow', function() {
    var id = $(this).data("id");
    url = "{{ url('SuperAdmin/Notice/edit')}}" + '/' + id,
        window.location = url;
});
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    type: "delete",
                    url: "{{ url('SuperAdmin/Notice/delete')}}" + '/' + id,
