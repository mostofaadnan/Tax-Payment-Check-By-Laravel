            ...
            <div class="col-sm-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('unionuser.update',$user->id) }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        ...
                                        value="{{ $user->name }}" required autocomplete="name" placeholder="name"
                                        autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="phone"
                                        ...
                                        value="{{ $user->phone }}" required autocomplete="phone" placeholder="Phone">
...
window.onload = State();
window.onload = function onLoadArea() {
    var stateid = "{{ $user->UnionName->UpazilaName->DistricName->StateName->id }}"
    var districtid = "{{ $user->UnionName->UpazilaName->DistricName->id }}"
    var upazilaid = "{{ $user->UnionName->UpazilaName->id }}"
    var unionid = "{{ $user->union_id }}"
    //District
    $.ajax({
        type: 'get',
        url: "{{ url('SuperAdmin/District/getlist')}}" + '/' + stateid,
        dataType: "JSON",
        success: function(data) {
            $("#district_id").empty();
            ...
            $("#district_id option[value='" + districtid + "']").attr('selected', 'selected');
        },
        error: function(data) {
            console.log(data);
        }
    ...
    $.ajax({
        type: 'get',
        url: "{{ url('SuperAdmin/Upazila/getlist')}}" + '/' + districtid,
        dataType: "JSON",
        success: function(data) {
            $("#upazila_id").empty();
            ...
            $("#upazila_id option[value='" + upazilaid + "']").attr('selected', 'selected');
        },
        error: function(data) {
            console.log(data);
        }
    ...
    $.ajax({
        type: 'get',
        url: "{{ url('SuperAdmin/Union/getlist')}}" + '/' + upazilaid,
        dataType: "JSON",
        success: function(data) {
            $("#union_id").empty();
            ...
            $("#union_id option[value='" + unionid + "']").attr('selected', 'selected');
        },
        error: function(data) {
            console.log(data);
        }
